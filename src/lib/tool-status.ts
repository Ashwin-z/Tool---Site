 ...
 *   - Ghostscript (`gs` / `gswin64c.exe`)  -> compress-pdf, pdf-to-pdfa
...
export const TOOL_OUTAGES: Record<string, ToolOutage> = {
  "compress-pdf": {
    ...
    userMessage:
      "PDF compression is temporarily offline while we rebuild it to run entirely in your browser.",
