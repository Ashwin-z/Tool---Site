...
export const toolRelatedMap: Record<string, string[]> = {
  ...
  "image-to-pdf": ["merge-pdf", "compress-pdf", "word-to-pdf", "pdf-to-jpg"],
  "word-to-pdf": ["excel-to-pdf", "powerpoint-to-pdf", "pdf-to-word", "compress-pdf"],
  "powerpoint-to-pdf": ["word-to-pdf", "excel-to-pdf", "pdf-to-powerpoint", "compress-pdf"],
  "excel-to-pdf": ["word-to-pdf", "powerpoint-to-pdf", "pdf-to-excel", "compress-pdf"],
  "html-to-pdf": ["word-to-pdf", "image-to-pdf", "compress-pdf", "pdf-to-text"],
  "pdf-to-jpg": ["pdf-to-word", "pdf-to-text", "image-to-pdf", "compress-pdf"],
  "pdf-to-word": ["word-to-pdf", "pdf-to-excel", "pdf-to-powerpoint", "pdf-to-text"],
  "pdf-to-powerpoint": ["powerpoint-to-pdf", "pdf-to-word", "pdf-to-excel", "compress-pdf"],
  "pdf-to-excel": ["excel-to-pdf", "pdf-to-word", "pdf-to-text", "compress-pdf"],
  "pdf-to-pdfa": ["protect-pdf", "compress-pdf", "pdf-to-text", "redact-pdf"],
  "pdf-to-text": ["pdf-to-word", "pdf-to-excel", "compress-pdf", "split-pdf"],
  ...
  "protect-pdf": ["unlock-pdf", "sign-pdf", "redact-pdf", "add-watermark-to-pdf"],
  "unlock-pdf": ["protect-pdf", "edit-pdf", "compress-pdf", "pdf-to-word"],
  "sign-pdf": ["protect-pdf", "redact-pdf", "edit-pdf", "add-watermark-to-pdf"],
  "redact-pdf": ["protect-pdf", "sign-pdf", "pdf-to-text", "compare-pdf"],
  "compare-pdf": ["edit-pdf", "pdf-to-word", "split-pdf", "redact-pdf"],
