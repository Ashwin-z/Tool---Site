...
src = r"C:\Users\Ashwin\Documents\Tool Site\tool-site\src\app\contact\page.tsx"
tmp = r"C:\Users\Ashwin\Documents\Tool Site\tool-site\src\app\contact\page_new.tsx"
    ...
    <main className="mx-auto min-h-screen w-full max-w-4xl px-6 py-12 text-foreground">
      ...
      <div className="mt-8 grid gap-4 md:grid-cols-2">
        <div className="rounded-xl border border-border bg-surface p-5">
          ...
          <a
            href="mailto:hello@toolmint.com"
        ...
        <div className="rounded-xl border border-border bg-surface p-5">
          ...
          <a
            href="mailto:partnerships@toolmint.com"
            className="mt-3 inline-block text-sm font-medium text-accent-light transition hover:text-foreground"
          >
            partnerships@toolmint.com
          </a>
        </div>
      </div>
...
with open(tmp, "w", encoding="utf-8") as f:
    f.write(content)
os.replace(tmp, src)
print("Contact page rewritten successfully!")
