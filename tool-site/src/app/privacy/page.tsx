  ...
  return (
    <main className="mx-auto min-h-screen w-full max-w-4xl px-6 py-12 text-[#eeeef5]">
      ...
      <div className="mt-8 space-y-6 text-sm leading-7 text-[#c4c4d4]">
        <section>
          <h2 className="font-display text-xl font-bold text-white">1) What we collect</h2>
        ...
        <section>
          <h2 className="font-display text-xl font-bold text-white">2) Cookies and ads</h2>
        ...
        <section>
          <h2 className="font-display text-xl font-bold text-white">3) Your content</h2>
        ...
        <section>
          <h2 className="font-display text-xl font-bold text-white">4) Contact</h2>
