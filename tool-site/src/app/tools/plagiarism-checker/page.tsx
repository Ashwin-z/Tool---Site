...
export const metadata: Metadata = {
  title: "Plagiarism Checker — Free Online Plagiarism Detection Tool",
  description:
    "Free online Plagiarism Checker. Scan your text for duplicate content across the web — coming soon.",
};
