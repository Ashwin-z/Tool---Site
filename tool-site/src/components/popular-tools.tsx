...
const popularTools = [
  ...
  { icon: "\u{1F4C4}", name: "PDF Compressor", desc: "Reduce PDF size while keeping the best quality possible.", tag: "Popular", href: "/tools/pdf-compressor" },
  { icon: "\u{1F9E9}", name: "PDF Merger", desc: "Merge up to 25 PDFs and rearrange them before download.", tag: "New", href: "/tools/pdf-merger" },
  { icon: "\u{2702}\u{FE0F}", name: "PDF Splitter", desc: "Split one PDF by range, fixed intervals, or selected pages.", tag: "New", href: "/tools/pdf-splitter" },
