...
export default function WordCounterTool({ compact = false }: WordCounterToolProps) {
  ...
  return (
    <div>
      <div className="overflow-hidden rounded-2xl border border-white/10 bg-[#111118] shadow-[0_20px_60px_rgba(0,0,0,.55)]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-[1fr_210px]">
          <textarea
            ...
            className={`w-full resize-none border-r border-white/10 bg-transparent px-5 py-4 text-sm leading-8 text-white outline-none placeholder:text-[#515168] ${
        ...
        <div className="flex flex-wrap items-center justify-between gap-3 border-t border-white/10 px-5 py-2.5">
      ...
      <div className="mt-4 overflow-hidden rounded-2xl border border-white/10 bg-[#111118] shadow-lg">
    ...
    <div className="bg-[#111118] px-4 py-3">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-2">
          ...
          <span className="text-xs font-medium text-[#c4c4d4]">{name}</span>
        </div>
        <span
