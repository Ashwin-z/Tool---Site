          ...
          <div className="overflow-hidden rounded-2xl border border-white/10 bg-[#111118] shadow-[0_20px_60px_rgba(0,0,0,.55)]">
            ...
            <div className="grid grid-cols-2 gap-4 p-5 sm:grid-cols-3 lg:grid-cols-4">
              {pages.map((page) => (
                <div
                  key={page.pageNumber}
                  className="group overflow-hidden rounded-xl border border-white/10 bg-[#17171f] transition hover:border-[#6c63ff]/30"
                >
                  {/* Thumbnail */}
                  ...
                  <div className="flex items-center justify-between px-3 py-2">
                    ...
                    <button
                      ...
                      className="rounded-lg bg-white/5 px-2.5 py-1.5 text-[10px] font-semibold text-[#9b9bb3] transition hover:bg-white/10 hover:text-white"
                    >
                      ⬇
                    </button>
                  </div>
